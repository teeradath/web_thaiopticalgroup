<?php echo form_open('tog_admin/users');?>
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header"><span class="glyphicon glyphicon-user"></span> Users</h1>
 	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-6" style="text-align: right;">
						<?php echo anchor('tog_admin/user_add','<span class="glyphicon glyphicon-plus"></span> เพิ่ม','class="btn btn-success"')?>
					</div>
				</div>
					...
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<?php if (count($users_list)>0):?>
							...
							<tr>
								...
								<td style="vertical-align: middle;"><?php echo $row['roles_name'];?> </td>
								<td align="center" style="vertical-align: middle;"><?php echo anchor('tog_admin/user_edit/'.$row['user_id'],'<span class="glyphicon glyphicon-edit"></span>','style="font-size:1.1em;"')?></td>
								<td align="center" style="vertical-align: middle;"><a href="#" style="color:#E05353 " style="font-size:1.1em;" onclick="del(<?php echo $row['user_id']?>)"><span class="glyphicon glyphicon-remove"></span></a></td>
							</tr>
							<?php endforeach;?>
						<?php else:?>
							<tr>
...
function del(id){
	if(confirm("Do you want to delete it?")){
		window.location.href = '<?php echo base_url().'tog_admin/user_delete'?>/'+id;
	}else{
		return false;
	}
}
