...
<?php echo form_open('tog_admin/user_add','id="form1"');?>
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header"><span class="glyphicon glyphicon-user"></span> Create User</h1>
 	</div>
	<!-- /.col-lg-12 -->
</div>
<div class="row">
				...
				<div class="col-sm-10" >
					<div class="form-horizontal" style="padding: 0 15px;">
						<div class="form-group <?php echo (form_error("txt_fullname")!=""?"has-error":"");?>">
					        ...
					        <input type="text" name="txt_fullname" class="form-control" placeholder="ชื่อ-สกุล..." value="<?php echo @$this->input->post('txt_fullname')?>">
					        <?php echo form_error("txt_fullname","<font color='error'>","</font>");?>
					    </div>
					    <div class="form-group <?php echo (form_error("txt_email")!=""?"has-error":"");?>">
					        <label>Email :</label>
					        <input type="email" name="txt_email" class="form-control" placeholder="Email..." value="<?php echo @$this->input->post('txt_email')?>">
					    ...
					    <div class="form-group <?php echo (form_error("dd_roles")!=""?"has-error":"");?>">
					        <label>Roles :</label>
					        <?php echo form_dropdown('dd_roles',$dd_roles,@$_POST['dd_roles'],'class="form-control"')?>
