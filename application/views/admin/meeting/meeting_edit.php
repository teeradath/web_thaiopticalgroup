...
<?php echo form_open_multipart('tog_admin/meeting_edit/'.$this->uri->segment(3),'id="form1"');?>
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header"><span class="glyphicon glyphicon-retweet"></span> แก้ไข การประชุมผู้ถือหุ้น</h1>
 	</div>
	<!-- /.col-lg-12 -->
</div>
<div class="row">
			...
			<div class="panel-body">
				...
				<div class="col-sm-10">
					...
					<div id="myTabContent" class="tab-content">
						<?php foreach ($meeting_arr as $row2): ?>
							<div class="tab-pane fade <?php echo $row2['lang_id']==1?'active':''; ?> in" id="news-<?php echo $row2['language']?>">
								<div class="form-group <?php echo (form_error("title_".$row2['language'])!=""?"has-error":"");?>">
									...
									<input type="text" name="title_<?php echo $row2['language'];?>" class="form-control" placeholder="หัวข้อ <?php echo $row2['language_text']?>.." value="<?php echo $row2['meeting_title']?>">
