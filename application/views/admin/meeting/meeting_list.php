<?php echo form_open('tog_admin/meeting_list');?>
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header"><span class="glyphicon glyphicon-retweet"></span> การประชุมผู้ถือหุ้น</h1>
 	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-6" style="text-align: right;">
						<?php echo anchor('tog_admin/meeting_add','<span class="glyphicon glyphicon-plus"></span> เพิ่ม','class="btn btn-success"')?>
					</div>
				</div>
 				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						<thead>
							<tr>
								<th width="10%" >วันที่ (ปี-เดือน-วัน)</th>
								<th width="" >Title</th>
						...
						<?php if (count($meeting_list)>0):?>
							<?php foreach ($meeting_list as $row):?>
							<tr>
								<td style="vertical-align: middle;"><?php echo $row['meeting_date'];?> </td>
								<td style="vertical-align: middle;"><?php echo $row['meeting_title'];?> </td>
								<td align="center" style="vertical-align: middle;"><?php echo anchor('tog_admin/meeting_edit/'.$row['meeting_id'],'<span class="glyphicon glyphicon-edit"></span>','style="font-size:1.1em;"')?></td>
								<td align="center" style="vertical-align: middle;"><a href="#" style="color:#E05353 " style="font-size:1.1em;" onclick="del(<?php echo $row['meeting_id']?>)"><span class="glyphicon glyphicon-remove"></span></a></td>
							</tr>
							<?php endforeach;?>
						<?php else:?>
							<tr>
...
function del(id){
	if(confirm("Do you want to delete it?")){
		window.location.href = '<?php echo base_url().'tog_admin/meeting_delete'?>/'+id;
	}else{
		return false;
	}
}
