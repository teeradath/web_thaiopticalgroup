...
<?php echo form_open_multipart('tog_admin/form_56_1_add','id="form1"');?>
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header"><span class="glyphicon glyphicon-paperclip"></span> สร้าง แบบฟอร์ม 56-1</h1>
 	</div>
	<!-- /.col-lg-12 -->
</div>
<div class="row">
