<?php echo form_open('tog_admin/annual_list');?>
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header"><span class="glyphicon glyphicon-file"></span> รายงานประจำปี</h1>
 	</div>
	<!-- /.col-lg-12 -->
</div>
<!-- /.row -->
			...
			<div class="panel-body">
				<div class="row">
					...
					<div class="col-md-6" style="text-align: right;">
						<?php echo anchor('tog_admin/annual_add','<span class="glyphicon glyphicon-plus"></span> เพิ่ม','class="btn btn-success"')?>
					</div>
				</div>
 				<div class="table-responsive">
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
						...
						<tbody>
						<?php if (count($annual_list)>0):?>
							<?php foreach ($annual_list as $row):?>
							<tr>
								<td align="center"> <?php echo anchor(base_url().$row['url_file'],'<img src="'.base_url().$row['url_image'].'" class="img-responsive" style="height: 100px;border:1px solid #999;">')?></td>
								<td style="vertical-align: middle;"> <?php echo $row['year'];?> </td>
								<td align="center" style="vertical-align: middle;"><?php echo anchor('tog_admin/annual_edit/'.$row['id'],'<span class="glyphicon glyphicon-edit"></span>','style="font-size:1.1em;"')?></td>
								<td align="center" style="vertical-align: middle;"><a href="#" style="color:#E05353 " style="font-size:1.1em;" onclick="del(<?php echo $row['id']?>)"><span class="glyphicon glyphicon-remove"></span></a></td>
							</tr>
							<?php endforeach;?>
						<?php else:?>
							<tr>
...
function del(id){
	if(confirm("Do you want to delete it?")){
		window.location.href = '<?php echo base_url().'tog_admin/annual_delete'?>/'+id;
	}else{
		return false;
	}
}
