...
<?php echo form_open_multipart('tog_admin/annual_add','id="form1"');?>
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header"><span class="glyphicon glyphicon-file"></span>สร้าง รายงานประจำปี</h1>
 	</div>
	<!-- /.col-lg-12 -->
</div>
<div class="row">
				...
				<div class="col-sm-10" >
					<div class="form-horizontal" style="padding: 0 15px;">
						<div class="form-group <?php echo (form_error("num_year")!=""?"has-error":"");?>">
					        <label>ปี พ.ศ.</label>
					        <input type="number" name="num_year" class="form-control" placeholder="ปี พ.ศ." value="<?php echo @$this->input->post('num_year')?>">
