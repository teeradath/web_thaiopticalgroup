...
<?php echo form_open_multipart('tog_admin/annual_edit/'.$this->uri->segment(3),'id="form1"');?>
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header"><span class="glyphicon glyphicon-file"></span>แก้ไข รายงานประจำปี</h1>
 	</div>
	<!-- /.col-lg-12 -->
</div>
<div class="row">
			...
			<div class="panel-body">
				...
				<div class="form-horizontal" style="text-align: right;">
					<div class="form-group">
						<div class="col-sm-offset-6 col-sm-6">
							<?php echo anchor('tog_admin/annual_list','Back','class="btn btn-primary"');?>
				...
				<div class="col-sm-10" >
					<div class="form-horizontal" style="padding: 0 15px;">
						<div class="form-group <?php echo (form_error("num_year")!=""?"has-error":"");?>">
					        <label>ปี พ.ศ.</label>
					        <input type="number" name="num_year" class="form-control" placeholder="ปี พ.ศ." value="<?php echo @$annual_arr[0]['year']?>">
				...
				<div class="col-sm-10">
					...
					<div id="myTabContent" class="tab-content">
						<?php foreach ($annual_arr as $row2): ?>
							<div class="tab-pane fade <?php echo $row2['lang_id']==1?'active':''; ?> in" id="news-<?php echo $row2['language']?>">
								<div class="form-group">
									<img alt="" src="<?php echo base_url().$row2['url_image']; ?>" style="border: 1px solid #999;height: 150px;margin-left: 80px;"><br>
						        	<label for="imgTitle_<?php  echo $row2['language'];?>"> <?php echo 'รุูป '.$row2['language_text'];?> <font color="error"> "174x250 Pixel .jpg|.png|.gif" </font> :</label>
		    						<input type="file" class="form-control" name="imgTitle_<?php  echo $row2['language'];?>" placeholder="<?php echo 'รูป '.$row2['language_text'];?>">
						       	</div>
								<div class="form-group">
									<label for="fileName_<?php echo $row2['language'];?>" style="color: green"><?php echo $row2['url_file']?></label><br>
									<label for="file_<?php echo $row2['language'];?>"><?php echo 'ไฟล์ '.$row2['language_text'];?> <font color="error"> ".pdf|.xls|.doc" </font> :</label>
